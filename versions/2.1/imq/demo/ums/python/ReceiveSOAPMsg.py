...
#
#
# @(#)ReceiveSOAPMsg.py	1.0 09/04/08
# 
#############################################################################
#
# A simple script to receive JMS text or binary message(s) as XML/SOAP message
# using UMS API over HTTP. When receiving a file, i.e. binary message,
