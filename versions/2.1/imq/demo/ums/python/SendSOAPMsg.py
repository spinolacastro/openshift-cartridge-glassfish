...
#
#
# @(#)send_soap_msg.py	1.0 09/04/08
# 
#############################################################################
#
# A simple script to send JMS text or binary message(s) as XML/SOAP message
# using UMS API over HTTP. When sending a file, i.e. a binary message,
# the content of the file is base64 encoded and place in the body of
# the SOAP message.
#  
# Note: Required Python 2.5 or later version due to dependency on the 
#       ElementTree XML API, i.e. xml.etree.ElementTree.
#
...
NS_MQ_SERVICE = "{https://mq.dev.java.net/ums}"
