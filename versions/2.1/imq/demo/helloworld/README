...
Sun Java(tm) System Message Queue Examples: helloworld
------------------------------------------------------
...
helloworldmessage        A "hello world" example that shows the fundamentals
			 ...
			 Quick Start Tutorial (chapter 2 of the Sun Java(tm) 
			 System Message Queue Developer's Guide). 
...
helloworldmessagejndi    A "hello world" example (similar to helloworldmessage)
			 ...
			 provided with Sun Java(tm) System Message Queue. This 
			 example is used as the sample application in the 
			 Administration Console Tutorial (chapter 4 of the Sun 
			 Java(tm) System Message Queue Administrator's Guide).
